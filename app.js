...
var sessionSettings = {
    ...
    "cookie": { "path": '/', "httpOnly": true, "secure": false,  "maxAge": 60000 * 15 }
};

/////////////////////////ここまでredis sessionstoreの設定////////////////////////
...
// //socket.io.sessionはexpress-sessionをベースにしているのでココはいらない。
...
//expressとのsession共有をする必要がある
//socket.io.sessionで実装
io.use(socketSession.parser);//追記！！socket.io 1.0 以降はミドルウェアとして直列に挿入できる
